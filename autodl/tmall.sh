...
#./bin/llama-server -m /root/autodl-tmp/models/llm/Qwen2-7B-Multilingual-RP.Q8_0.gguf -ngl 100 --host 0.0.0.0 --port 8080
nohup ./bin/llama-server -m /root/autodl-tmp/models/llm/Qwen2-7B-Multilingual-RP.Q8_0.gguf -ngl 100 --host 0.0.0.0 --port 8080  > output.log 2>&1 & echo $! > pid.txt
#tail -f output.log
